...
class Resynth:
    ...
    def process(
        ...
        glottis_poles = np.apply_along_axis(np.roots, 1, glottis_coeffs.astype(np.complex64))
        ...
        tract_poles = np.apply_along_axis(np.roots, 1, tract_coeffs.astype(np.complex64)) # TODO .imag > 0
